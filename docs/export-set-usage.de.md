...
| --- | --- | --- |
| `<set-slug>` | Set-Id aus dem Wurzel-`manifest.yaml` oder der Ordnername des Set-Pfads (hier beides `waehrung-des-geistes`; Pfad `sets/de/waehrung-des-geistes`) | Pflicht |
