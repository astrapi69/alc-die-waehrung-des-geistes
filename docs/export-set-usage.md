...
| --- | --- | --- |
| `<set-slug>` | Set id from the root `manifest.yaml` or the folder name of the set path (both `waehrung-des-geistes` here; path `sets/de/waehrung-des-geistes`) | required |
...
make export ARGS="waehrung-des-geistes --format json --out /tmp/review.json"

# Large set: split into parts of at most 4 lessons each for an AI with a
# limited context window
make export ARGS="waehrung-des-geistes --split-size 4"
# -> exports/waehrung-des-geistes-de-<timestamp>-part01-of-3.yaml, part02-of-3, part03-of-3
```
